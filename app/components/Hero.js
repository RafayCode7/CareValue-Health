  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between py-20 px-6 md:px-24 bg-gradient-to-b from-white to-gray-100">
      ...
      <div className="flex-1 flex justify-center md:justify-end w-full md:max-w-md lg:max-w-lg xl:max-w-2xl">
        <div className="relative w-full h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] xl:h-[450px] overflow-hidden rounded-lg shadow-xl transition-transform duration-300 transform hover:scale-105">
